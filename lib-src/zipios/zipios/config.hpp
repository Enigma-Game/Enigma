/* zipios/config.hpp.  Generated from config.hpp.in by configure.  */
/* zipios/config.hpp.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_STRING "zipios 2.2.6"
