...
** Jul 1998
** $Id: tolua.h,v 1.2 2003/05/19 12:12:43 reallysoft Exp $
*/
...
#define TOLUA_VERSION       "tolua 4.0a"
...
void tolua_constant (lua_State* L, const char* parent, const char* name, double value);
void tolua_tablevar
