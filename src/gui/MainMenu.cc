...
//    }
    ...
    static const char *credit_text[] = {
        ...
        " ",
        "  Raoul Bourquin  (Level administration, level updates, level design)",
        ...
        "  Ronald Lamprecht  (XML, Gui, portability, documentation)",
        ...
        "  Samuel El?as Martínez ?lvarez  (Spanish translation)",
