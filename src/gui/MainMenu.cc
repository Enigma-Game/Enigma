...
//    }
    ...
    static const char *credit_text[] = {
        ...
        "  Alain Busser (Level design)",
        "  Guy Busser (Level design)",
        "  Richi Buetzer (Level design)",
        "  capkoh (Level design)",
        "  Sergej Dremuk (Russian translation)",
        ...
        "  Juhasz Mate Lehel (Hungarian translation)",
