...
/* -------------------- Helper routines -------------------- */
    ...
    static const char *credit_text[] = {
        ...
        " ",
        "  Thomas Bernhardt  (Level design and testing)",
        ...
        "  Michał Trzebiatowski  (translation administration, Czech, German,",
        ...
        "  Γιάννης Ανθυμίδης  (Greek translation)",
