...
enigma.SendMessage(enigma.GetNamedObject("door3"), "openclose", nil)
end

function door45()
enigma.SendMessage(enigma.GetNamedObject("door4"), "openclose", nil)  
enigma.SendMessage(enigma.GetNamedObject("door5"), "openclose", nil)
end
...
-- starting point
set_actor("ac-blackball", 2.5,35.5, {player=0}) set_floor("fl-metal",2,35)
