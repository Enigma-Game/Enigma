...
draw_stones("st-rock2", {3,3}, {0,1},7)
draw_stones("st-rock2", {6,5}, {0,1},5)
draw_stones("st-rock2", {14,1}, {0,1},5)
draw_stones("st-rock2", {4,3}, {1,0},4)
draw_stones("st-rock2", {17,1}, {0,1},4)
draw_stones("st-rock2", {17,6}, {0,1},2)
draw_stones("st-rock2", {9,10}, {1,0},3)
draw_stones("st-rock2", {8,1}, {0,1},2)
draw_stones("st-rock2", {4,9}, {1,0},2)
...
set_stones("st-rock2", {{3,11},{9,11},{14,11},{13,3},{18,7},{14,8},
