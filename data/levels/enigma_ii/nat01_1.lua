...
set_stone( "st-rock2", 7, 6 )

draw_stones( "st-rock2", {5,2}, {1,0}, 5 )
draw_stones( "st-rock2", {9,3}, {1,0}, 6 )
draw_stones( "st-rock2", {14,3}, {0,1}, 3 )
set_stone( "st-rock2", 15, 5 )

draw_stones( "st-rock2", {5,10}, {1,0}, 5 )
draw_stones( "st-rock2", {9,9}, {1,0}, 6 )
draw_stones( "st-rock2", {14,9}, {0,-1}, 3 )
set_stone( "st-rock2", 15, 7 )

draw_stones( "st-rock2", {5,4}, {1,0}, 3 )
draw_stones( "st-rock2", {5,8}, {1,0}, 3 )

draw_stones( "st-rock2", {10,5}, {1,0}, 3 )
draw_stones( "st-rock2", {10,7}, {1,0}, 3 )
...
oxyd(1,1)
set_stone( "st-rock2", 2, 1 )
set_stone( "st-rock2", 2, 2 )
doorv( 2, 3, {name="door1"} )
set_stone( "st-rock2", 2, 4 )
set_stone( "st-rock2", 2, 5 )
oxyd(1,5)

oxyd(1,level_height-2)
set_stone( "st-rock2", 2, level_height-2 )
set_stone( "st-rock2", 2, level_height-3 )
doorv( 2, level_height-4, {name="door2"} )
set_stone( "st-rock2", 2, level_height-5 )
set_stone( "st-rock2", 2, level_height-6 )
