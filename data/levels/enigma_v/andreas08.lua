-- Tropical Island, a level for Enigma
...
SetAttrib(enigma.GetItem(30,5),"text","Why has there always to be an active volcano and a village of marble-eating inhabitants on a tropical island?")
