...
draw_stones("st-metal", {1,12}, {1,0},12)
draw_stones("st-metal", {14,12}, {1,0},4)
draw_stones("st-metal", {4,1}, {0,1},2)
draw_stones("st-metal", {5,9}, {0,1},2)
draw_stones("st-metal", {1,9}, {1,0},1)
draw_stones("st-metal", {10,2}, {0,1},3)
draw_stones("st-metal", {9,4}, {1,0},1)
draw_stones("st-metal", {8,5}, {1,0},1)
draw_stones("st-metal", {8,7}, {1,0},3)
draw_stones("st-metal", {11,11}, {1,0},1)
draw_stones("st-metal", {13,7}, {0,1},2)
draw_stones("st-metal", {14,8}, {0,1},3)
draw_stones("st-metal", {15,8}, {0,1},2)
draw_stones("st-metal", {11,5}, {1,0},1)
...
draw_stones("st-metal", {4,22}, {0,1},2)
draw_stones("st-metal", {5,14}, {0,1},2)
draw_stones("st-metal", {1,15}, {1,0},1)
draw_stones("st-metal", {10,20}, {0,1},3)
draw_stones("st-metal", {9,20}, {1,0},1)
draw_stones("st-metal", {8,19}, {1,0},1)
draw_stones("st-metal", {8,17}, {1,0},3)
draw_stones("st-metal", {11,13}, {1,0},1)
draw_stones("st-metal", {13,16}, {0,1},2)
draw_stones("st-metal", {14,14}, {0,1},3)
draw_stones("st-metal", {15,15}, {0,1},2)
draw_stones("st-metal", {11,19}, {1,0},1)
