...
SetAttrib(enigma.GetItem(3,3),"text","Use the right mouse-button to rotate your inventory,  it's the bar at the bottom of the screen.   And guess what these three items down there can be used to.")
