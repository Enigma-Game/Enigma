...
--xml--       <el:identity el:titel="Basketball" el:subtitel="Pass the ball in time" el:id="ral03"/>
...
--xml--       </el:comments>
--xml--       <el:score el:easy="-1" el:difficult="47"/>
--xml--     </el:info>
...
--xml--         <el:translation el:lang="de">Rechtzeitige Ballabgabe</el:translation>
--xml--       </el:string>
--xml--     </el:i18n>
--xml--   </el:protected>
--xml-- </el:level>
