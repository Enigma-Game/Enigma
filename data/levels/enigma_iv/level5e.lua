...
set_stone("st-oneway-w", 15,4)
set_stone("st-oneway-n", 37,7)
set_stone("st-oneway-n", 35,4)
set_stones("st-bombs", {{38,11}})
draw_stones("st-stone_break", {2,6}, {1,0},1)
draw_stones("st-wood", {39,6}, {1,0},1)
set_stone("st-bolder-e", 1,6)
set_stone("st-bolder-e", 45,2)
set_stone("st-bolder-e", 49,10)
set_stone("st-bolder-n", 44,6)
set_stone("st-bolder-e", 43,7)
set_stone("st-bolder-n", 53,8)
set_stone("st-bolder-w", 54,3)
set_stone("st-bolder-s", 50,2)
...
set_item("it-coin2", 22,2)
set_item("it-coin2", 21,6)
