...
def_floor("fl-leavesb",      4.0,   1.5)
def_floor("fl-leavesc1",      4.0,   1.5)
def_floor("fl-leavesc2",      4.0,   1.5)
def_floor("fl-leavesc3",      4.0,   1.5)
def_floor("fl-leavesc4",      4.0,   1.5)
def_floor("fl-leavesd1",      4.0,   1.5)
def_floor("fl-leavesd2",      4.0,   1.5)
def_floor("fl-leavesd3",      4.0,   1.5)
def_floor("fl-leavesd4",      4.0,   1.5)
def_floor("fl-leavese1",      4.0,   1.5)
def_floor("fl-leavese2",      4.0,   1.5)
def_floor("fl-leavese3",      4.0,   1.5)
def_floor("fl-leavese4",      4.0,   1.5)
def_floor("fl-light",       2.2,   1.6)
def_floor("fl-lightgray",   3.0,   1.6)
def_floor("fl-darkgray",    3.0,   1.6)
def_floor("fl-marble",      6.4,   2.0)
def_floor("fl-metal",       3.0,   2.0)
def_floor("fl-metal1",       3.0,   2.0)
def_floor("fl-metal2",       3.0,   2.0)
def_floor("fl-metal3",       3.0,   2.0)
def_floor("fl-metal4",       3.0,   2.0)
def_floor("fl-metal5",       3.0,   2.0)
def_floor("fl-metal6",       3.0,   2.0)
...
def_floor("fl-samba1",      6.0,   2.0)
def_floor("fl-samba2",      6.0,   2.0)
...
def_floor("fl-wood1",       6.4,   2.0)
def_floor("fl-wood2",       6.4,   2.0)
def_floor("fl-woven",       6.5,   3.0)
def_floor("fl-woven_orange", 2.5,   0.0)
